...
<section>
<h2>이용자 보호</h2>
<p>예약 정보는 예약 확인과 연락 목적으로만 사용하고, 상담·예약이 끝난 뒤에는 보관을 최소화합니다. 불법·선정적 서비스나 무리한 요청에는 어떤 경우에도 응하지 않으며, 관련 법령과 위생·안전 기준을 따릅니다. 이용 중 궁금한 점은 운영 기준 페이지와 예약 전 확인 페이지에서 확인할 수 있습니다.</p>
</section>
